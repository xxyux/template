...
二分模板一共有两个，分别适用于不同情况。
算法思路：假设目标值在闭区间`[l, r]`中， 每次将区间长度缩小一半，当<img src="https://latex.codecogs.com/gif.latex?l%20=%20r"/>时，我们就找到了目标值。
  
####  1.2.1版本1
  
当我们将区间`[l, r]`划分成`[l, mid]`和`[mid + 1, r]`时，其更新操作是<img src="https://latex.codecogs.com/gif.latex?r%20=%20mid"/>或者<img src="https://latex.codecogs.com/gif.latex?l%20=%20mid%20+%201"/>，计算<img src="https://latex.codecogs.com/gif.latex?mid"/>时不需要加1。
...
当我们将区间`[l, r]`划分成`[l, mid - 1]`和`[mid, r]`时，其更新操作是<img src="https://latex.codecogs.com/gif.latex?r"/> = <img src="https://latex.codecogs.com/gif.latex?mid"/> - <img src="https://latex.codecogs.com/gif.latex?1"/>或者<img src="https://latex.codecogs.com/gif.latex?l"/> = <img src="https://latex.codecogs.com/gif.latex?mid"/>，此时为了防止死循环，计算<img src="https://latex.codecogs.com/gif.latex?mid"/>时需要加<img src="https://latex.codecogs.com/gif.latex?1"/>。
...
给定一个按照升序排列的长度为<img src="https://latex.codecogs.com/gif.latex?n"/>的整数数组，以及<img src="https://latex.codecogs.com/gif.latex?q"/>个查询。
  
对于每个查询，返回一个元素<img src="https://latex.codecogs.com/gif.latex?k"/>的起始位置和终止位置（位置从 0 开始计数）。
```cpp
#include<bits/stdc++.h>
...
给<img src="https://latex.codecogs.com/gif.latex?n"/>个字符串，插入和询问两种操作
```cpp
#include<bits/stdc++.h>
using namespace std;
...
如果 <img src="https://latex.codecogs.com/gif.latex?N%20=%20{p1}^{c1}%20*%20{p2}^{c2}%20*%20...%20*{pk}^{ck}"/>
约数个数： <img src="https://latex.codecogs.com/gif.latex?(c1%20+%201)%20*%20(c2%20+%201)%20*%20...%20*%20(ck%20+%201)"/>
约数之和： <img src="https://latex.codecogs.com/gif.latex?({p1}^0%20+%20{p1}^1%20+%20...%20+%20{p1}^{c1})%20*%20...%20*%20({pk}^0%20+%20{pk}^1%20+%20...%20+%20{pk}^{ck})"/>
